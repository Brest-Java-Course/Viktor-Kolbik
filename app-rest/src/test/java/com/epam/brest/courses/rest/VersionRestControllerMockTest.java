...
public class VersionRestControllerMockTest {
    ...
    @Before
    public void setUp(){
        this.mockMvc = standaloneSetup(versionRestController).setMessageConverters(new MappingJackson2HttpMessageConverter()).build();
    }

    @Test
    public void getRestApiVersionTest() throws Exception{
        this.mockMvc.perform(get("/version", "Empty").accept(MediaType.APPLICATION_JSON))
                .andDo(print())
